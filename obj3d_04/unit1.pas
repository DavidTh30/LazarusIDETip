...
uses
  ...
  BGRAOpenGL, BGRAVirtualScreen, BGRABitmap, BGRAScene3D;
...
begin
  self.Caption := 'TBGRAVirtualScreen test';
  scene := TBGRAScene3D.Create;
  Timer1.Enabled := True;
end;
...
begin
  Bitmap.FillRect(rect(0, 0, Bitmap.Width, Bitmap.Height), BGRABlack, dmSet);
